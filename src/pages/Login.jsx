  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (!profile || !profile.username) {
        toast.error("Por favor, complete seu perfil antes de continuar.");
              ...
              <div className="login-fields">
                ...
                <div className="form-group">
                  ...
                  <div className="input-group">
                    ...
                    />
                    <button type="button" className="password-toggle" onClick={togglePasswordVisibility} aria-label="Mostrar senha">
